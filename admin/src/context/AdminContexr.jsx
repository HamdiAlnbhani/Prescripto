...
const AdminContextProvider =(props)=>{
   ...
   const [dashData,setDashData]=useState(false)
    ...
    if(!backendUrl){
        toast.error("Backend URL is not defined in environment variables")
    }
   ...
   const getDashData=async()=>{
    ...
    const value={
        aToken,setAToken,backendUrl,getAllDoctors,doctors,changeAvaibility,appointments,setAppointments,getAllAppointments,cancelAppointment,dashData,getDashData
    }
